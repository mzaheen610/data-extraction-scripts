...
from sqlalchemy import BigInteger, Boolean, DateTime, Float, Integer, Numeric, String, Text, VARBINARY, Time, LargeBinary
...
def generate_sql_for_schema():
    ...
    engine = create_engine("postgresql://factadmin:Weavers#456@172.210.3.233:5432/test_potgres_database")
